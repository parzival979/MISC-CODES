...
plot3(q_goal(1), q_goal(2), 0, 'ro', 'MarkerFaceColor', 'r', 'MarkerSize', 8);
...
h_robot = patch('XData', [], 'YData', [], 'ZData', [], 'FaceColor', 'white');
h_trail = plot3(x_robot, y_robot, interp2(X, Y, U_total, x_robot, y_robot), 'b-', 'LineWidth', 2);
...
for i = 1:N-1
    ...
    set(h_trail, 'XData', x_history(1:i+1), 'YData', y_history(1:i+1), 'ZData', interp2(X, Y, U_total, x_history(1:i+1), y_history(1:i+1)));
