...
/* 
	Perturbed tcas.c for Software Analysis Assignment #4 - Static analyzer
*/
...
int ALIM ()
{
	int alim = 0;
	if(Climb_Inhibit){
		int altitude = 1000000000;
		int Local_Positive_RA_Alt_Thresh;
		Local_Positive_RA_Alt_Thresh = 740;
		alim = Local_Positive_RA_Alt_Thresh * altitude;
	}
	else{
		switch(Alt_Layer_Value){
			case 1:
				alim = Positive_RA_Alt_Thresh[1];
				break;
			case 2:
				alim = Positive_RA_Alt_Thresh[2];
				break;
			case 3:
				alim = Positive_RA_Alt_Thresh[3];
				break;
			case 4:
				alim = Positive_RA_Alt_Thresh[4];
				break;
		}
	}
	return alim;
...
bool Non_Crossing_Biased_Climb()
{
    ...
    upward_preferred = upward_preferred = Inhibit_Biased_Climb() / Positive_RA_Alt_Thresh[Alt_Layer_Value];
    if (upward_preferred)
    {
