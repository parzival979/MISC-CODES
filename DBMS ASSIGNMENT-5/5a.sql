create database if not exists Q5A_DATABASE;
use Q5A_DATABASE;
...
insert into Orders(ord_num, ord_amount, advance_amount, ord_date, cust_code, agent_code, description) VALUES (008,700,100,'19-feb-2019','C007','Ac005',null);
insert into Orders(ord_num, ord_amount, advance_amount, ord_date, cust_code, agent_code, description) VALUES (009,10000,600,'21-march-2010','C009','Ac008','Masala Dosa');
insert into Orders(ord_num, ord_amount, advance_amount, ord_date, cust_code, agent_code, description) VALUES (010,20,600,'21-apr-2012','C006','Ac005',null);

# Agent Entry
insert into Agent(agent_code, agent_name, working_area, commission, phone_no, Country) VALUES ('Ac001','Ramesh','Bangalore',0.15,'0331234567','india');
